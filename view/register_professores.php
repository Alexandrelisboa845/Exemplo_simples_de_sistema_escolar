...
<body>
    <div class="register-container">
        ...
        <form action="../controller/professorcreat.php" method="post">
            <div>
            ...
            <div>
                ...
                <select class="custom-select" name="disciplina_leciona">
                    <?php
                      foreach ($DisciplinaDAO->Read() as $DisciplinaDAO) :
                        $count++;
                    ?>
                        <option value="<?php echo $DisciplinaDAO->getId()?>" ><?php echo $DisciplinaDAO->getNomeDisciplina() ?></option>
