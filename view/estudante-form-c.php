...
<div class="login-container">
    ...
    <form method="post" action="../controller/EstudanteController.php">
      <div class="form-group">
        ...
        <input type="number" class="form-control" name="numero" placeholder="Numero de estudante">
      </div>
      <div class="form-group">
        <label>Nome</label>
      ...
      <div class="form-group">
        <label>P1</label>
        <input type="number" class="form-control" name="p1" placeholder="0 a 20" require>
      </div>
      <div class="form-group">
        <label>P2</label>
        <input type="number" maxlength="2" class="form-control" name="p2" placeholder="0 a 20" require>
      </div>
      <div class="form-group">
        <label>Exame</label>
        <input type="number" class="form-control" name="exame" placeholder="0 a 20" require>
      </div>      
